      ...
      <Container className="flex justify-center align-center">
        ...
        >
          <div className="text-center px-5">
            ...
            <p className="mt-2 text-heading-3"> AI Models Developed</p>
          </div>
          <div className="text-center px-5">
            <h2 className="font-semibold text-xl sm:text-2xl md:text-4xl text-heading-1">
              {" "}
            ...
            <p className="mt-2 text-heading-3"> Demo Freshers</p>
          </div>
          <div className="text-center px-5">
            <h2 className="font-semibold text-xl sm:text-2xl md:text-4xl text-heading-1">
              {" "}
            ...
            <p className="mt-2 text-heading-3"> Service Reliability</p>
          </div>
          <div className="text-center px-5">
            <h2 className="font-semibold text-xl sm:text-2xl md:text-4xl text-heading-1">
              {" "}
