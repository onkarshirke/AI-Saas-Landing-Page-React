      ...
      <Container className="flex flex-col lg:flex-row gap-10 lg:gap-12">
        ...
        >
          ...
          <Paragraph className="mt-8">
            Our intelligent SaaS solution integrates effortlessly with your current
            processes to provide instant analytics, smart automation, and
            data-driven strategies. Step into a future where your enterprise operates
            more intelligently, swiftly, and effectively.
          </Paragraph>
          <div className="mt-10 w-full flex max-w-md mx-auto lg:mx-0">
            <div className="flex sm:flex-row flex-col gap-5 w-full">
              ...
              >
                ...
                <input
                  type="text"
                  placeholder="Message to Collaborate"
                  className="w-full py-3 outline-none bg-transparent"
                  value={message}
                  onChange={(e) => setMessage(e.target.value)}
                />
                <Button type="submit" className="min-w-max">
                  <span className="relative z-[5]">Send</span>
                </Button>
              </form>
              {showPopup && (
        ...
        <div className="flex flex-1 lg:w-1/2 lg:h-auto relative lg:max-w-non lg:mx-0 mx-auto max-w-3xl">
          <img
            src="public/assets/logos/one.jpg"
            alt="Hero image"
            width={2350}
            height={2359}
            className="lg:absolute lg:w-full lg:h-full rounded-3xl object-cover lg:max-h-non max-h-96 shadow-none"
          />
        </div>
      </Container>
      <Numbers />
