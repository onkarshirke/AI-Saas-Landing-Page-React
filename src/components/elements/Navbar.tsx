        ...
        <nav className="w-full flex justify-between gap-6 relative">
          ...
          <div className="min-w-max inline-flex relative">
            <a href="/" className="relative flex items-center gap-3">
              ...
              <div className="inline-flex text-lg font-semibold text-heading-1 bg-gradient-to-r from-purple-900 via-pink-900 to-purple-900 bg-clip-text text-transparent font-extrabold drop-shadow-[0_0_10px_rgba(128,0,128,0.9)]">
                ALPHA
              </div>
            </a>
          </div>
